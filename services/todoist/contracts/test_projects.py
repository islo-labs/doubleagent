...
def test_complete_project_lifecycle(todoist_client: TodoistAPI):
    ...
    # Archive
    todoist_client.archive_project(project_id=project.id)
    archived = todoist_client.get_project(project_id=project.id)
    assert archived.is_archived is True

    # Unarchive
    todoist_client.unarchive_project(project_id=project.id)
    unarchived = todoist_client.get_project(project_id=project.id)
