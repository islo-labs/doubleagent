...
@contract_test
def test_post_message(slack_client: WebClient, target: Target):
...
@contract_test
def test_update_message(slack_client: WebClient, target: Target):
...
@contract_test
def test_delete_message(slack_client: WebClient, target: Target):
...
@contract_test
def test_conversation_history(slack_client: WebClient, target: Target):
...
@contract_test
def test_add_reaction(slack_client: WebClient, target: Target):
